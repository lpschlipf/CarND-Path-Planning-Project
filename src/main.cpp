...
int main() {
  ...
  // Simulator always starts on center lane
  int lane = 1;
  double ref_vel = 0;
          ...
          if (s != "") {
            ...
            if (event == "telemetry") {
              ...
              for (int i = 0; i < sensor_fusion.size(); i++)
              {
                ...
                {
                  // vehicle in our lane.
                  car_proximity |= check_car_s > car_s && check_car_s - car_s < 30;
                }
              ...
              if (car_proximity)
              {
                ...
                {
                  // decelerate, there is a car in front of us and we cannot evade it!
                  ref_vel -= 0.25;
                }
              }
              else
              {
                if (lane != 1)
                {
                  // Let's try to get back to the center lane!
                  if (lane == 0 && !car_right)
                  {
                    lane = 1;
                  }
